...
class _DashboardScreenState extends ConsumerState<DashboardScreen>
  ...
  void _toggleNotifOverlay() {
    ...
    // Use cached docs immediately if available, otherwise wait for stream
    final docs = _latestNotificationDocs;
    
    // If we have cached docs, show overlay immediately
    if (docs.isNotEmpty) {
      _showNotifOverlay(docs, uid);
      return;
    }
    ...
    completer.future.then((freshDocs) {
      if (!mounted) return;
      _showNotifOverlay(freshDocs.isNotEmpty ? freshDocs : docs, uid);
    });
  }
  ...
  void _shareSearchResult(_SearchResult r) {
    ...
    final link = 'https://prepora.vercel.app/open/folder/${r.folderId}/$slug/share?id=$id&type=$type$parentParam';
    Share.share('${r.title}\n$link');
  }
                    ...
                    child: PopupMenuButton<String>(
                      ...
                      onSelected: (value) {
                        if (value == 'share') {
                          ...
                          final link = 'https://prepora.vercel.app/open/folder/$folderId/$slug/share?id=$folderId&type=folder';
