...
class _FolderDetailsScreenState extends ConsumerState<FolderDetailsScreen> {
  ...
  void _shareContent(String contentId, String contentName, String type) {
    ...
    final link = 'https://prepora.pages.dev/open/folder/${widget.folderId}/$slug/share?id=$contentId&type=$type&parent=${widget.folderId}';
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
        Row(children: [
          ...
          _uploadActionBtn(Icons.close_rounded, Colors.redAccent, 'Cancel All', () {
            mgr.cancelFolder(widget.folderId);
          }),
        ]),
        const SizedBox(height: 8),
